    ...
    return (
      <div style={authStyles.shell}>
        <div style={authStyles.card}>
          ...
          <h1 style={{ marginBottom: 8 }}>Sign in to your training workspace</h1>
          <p style={{ marginTop: 0, marginBottom: 20, lineHeight: 1.5 }}>
            Your program, exercise swaps, notes, and history are now tied to your account.
          </p>
          {(authError || error) && <p style={{ color: '#fca5a5' }}>{authError || error}</p>}
